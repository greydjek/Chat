...
netWorkService.sendMessage(privatMessage);System.out.println(" message Send Private message MCC");
}
     else {
        ...
        case "/broadcast":
          //  System.out.println("MainChat controller send message");
           ...
           this.greatHistory = new greatHistory();
            greatHistory.reedAndWriteInTxtFile(splitMessage[1], splitMessage[2]);
